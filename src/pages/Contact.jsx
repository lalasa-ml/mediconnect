    ...
    <div>
        ...
        <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
          ...
          <div className='flex flex-col justify-center items-start gap-6'>
            ...
            <p className='text-gray-500'>17th Cross, Richmond Street <br /> Ring Road, Bengaluru, Karnataka – 560025</p>
            <p className='text-gray-500'>Tel: +91 1234567890 <br /> Email: mediconnect@gmail.com</p>
